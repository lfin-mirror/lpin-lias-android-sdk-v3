...
struct jpeg_decompress_struct {
  ...
  int enable_external_quant;/* enable future use of android.external colormap */
...
/* Short forms of android.external names for systems with brain-damaged linkers.
 * We shorten android.external names to be unique in the first six letters, which
