...
public class IBeacon extends ADManufacturerSpecific {
     ...
     * Constructor.
     *
     * @param length    The length of the AD structure.
     * @param type      The AD type. The value should always be 0xFF
     *                  (Manufacturer Specific Data).
     * @param data      The AD data whose format is <i>iBeacon</i>.
     * @param companyId The company ID. The value should always be 0x004C
     *                  (Apple, Inc.).
     * @throws IllegalArgumentException {@code data} is {@code null} or the length of
     ...
     *
     * @param uuid The proximity UUID. The value must not be {@code null}.
     * @throws IllegalArgumentException The given value is {@code null}.
     */
     ...
     *
     * @param major The major number. The value should be in the range from 0 to 65535.
     * @throws IllegalArgumentException The given value is out of the valid range.
     */
     ...
     *
     * @param minor The minor number. The value should be in the range from 0 to 65535.
     * @throws IllegalArgumentException The given value is out of the valid range.
     */
     ...
     * Set the power.
     *
     * @param power The power. The value should be in the range from -128 to 127.
     * @throws IllegalArgumentException The given value is out of the valid range.
     */
    ...
    private int buildMajor(byte[] data) {
        return BeaconBytes.parseBE2BytesAsInt(data, MAJOR_INDEX);
    }


    private int buildMinor(byte[] data) {
        return BeaconBytes.parseBE2BytesAsInt(data, MINOR_INDEX);
    }
     ...
     *
     * @param length    The length of the AD structure.
     * @param type      The AD type. The value should always be 0xFF which represents
     *                  <i>Manufacturer Specific Data</i>.
     * @param data      The AD type. The value of the first two bytes is the company ID.
     * @param companyId The company ID. The value should always be 0x004C which represents
     *                  <i>Apple, Inc.</i>
     * @return An {@link IBeacon} instance. {@code null} is returned if the
