...
protected:
    void initialize(const type_record &rec) {
        ...
        if (rec.module_local) {
            // Stash the local typeinfo and loader so that android.external modules can access it.
 ...
 *    can be handy to prevent cases where callbacks issued from an android.external
