    ...
    class vectorstream : public std::iostream
    {
        /*!
            WHAT THIS OBJECT REPRESENTS
                ...
                only be accessed by copying it out, the vectorstream uses an android.external
                std::vector<char> as its buffer.  That is, it holds a reference to an
                android.external vector and does not contain any internal buffers of its own.
